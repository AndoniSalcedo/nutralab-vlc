    ...
    <BoneyardSkeleton name="team-config" loading={false}>
      <Stack gap="lg">
        <Paper p="md" radius="lg" shadow="sm" withBorder bg="white">
          <Group justify="space-between" align="center" mb="lg" wrap="wrap" gap="sm" style={{ width: '100%' }}>
            <Group gap="sm" style={{ flex: '1 1 auto', minWidth: 0 }}>
              <ThemeIcon size="md" radius="xl" variant="light" color="blue" style={{ flexShrink: 0 }}>
                <IconSettings size={18} />
              </ThemeIcon>
              <Box style={{ minWidth: 0 }}>
                <Group gap="xs" align="center" wrap="wrap">
                  <Title order={4} c="dark.4">General</Title>
                  {hasInfoChanges && (
        ...
        <Paper p="md" radius="lg" shadow="sm" withBorder>
          <Group justify="space-between" align="center" mb="lg" wrap="wrap" gap="sm" style={{ width: '100%' }}>
            <Group gap="sm" style={{ flex: '1 1 auto', minWidth: 0 }}>
              <ThemeIcon size="md" radius="xl" variant="light" color="gray" style={{ flexShrink: 0 }}>
                <IconBook size={18} />
              </ThemeIcon>
              <Box style={{ minWidth: 0 }}>
                <Group gap="xs" align="center" wrap="wrap">
        ...
        <Paper p="md" radius="lg" shadow="sm" withBorder>
          <Group justify="space-between" align="center" mb="lg" wrap="wrap" gap="sm" style={{ width: '100%' }}>
            <Group gap="sm" style={{ flex: '1 1 auto', minWidth: 0 }}>
              <ThemeIcon size="md" radius="xl" variant="light" color="pink" style={{ flexShrink: 0 }}>
                <IconPalette size={18} />
              </ThemeIcon>
              <Box style={{ minWidth: 0 }}>
                <Group gap="xs" align="center" wrap="wrap">
        ...
        <Paper p="md" radius="lg" shadow="sm" withBorder>
          <Group justify="space-between" align="center" mb="lg" wrap="wrap" gap="sm" style={{ width: '100%' }}>
            <Group gap="sm" style={{ flex: '1 1 auto', minWidth: 0 }}>
              <ThemeIcon size="md" radius="xl" variant="light" color="grape" style={{ flexShrink: 0 }}>
        ...
        <Paper p="md" radius="lg" shadow="sm" withBorder>
          <Group justify="space-between" align="center" mb="lg" wrap="wrap" gap="sm" style={{ width: '100%' }}>
            <Group gap="sm" style={{ flex: '1 1 auto', minWidth: 0 }}>
              <ThemeIcon size="md" radius="xl" variant="light" color="cyan" style={{ flexShrink: 0 }}>
                ...
                <Accordion.Item key={d.key} value={d.key} style={{ backgroundColor: 'white' }}>
                  <Accordion.Control>
                    <Group gap="sm">
                      ...
                      <Text size="xs" c="dimmed" fw={600}>{dayProtocols.length} {dayProtocols.length === 1 ? 'protocolo' : 'protocolos'}</Text>
                    </Group>
                  </Accordion.Control>
                  <Accordion.Panel>
                    <Stack gap="md">
        ...
        <Paper p="md" radius="lg" shadow="sm" withBorder>
          <Group justify="space-between" align="center" mb="md" wrap="wrap" gap="sm" style={{ width: '100%' }}>
            <Group gap="sm" style={{ flex: '1 1 auto', minWidth: 0 }}>
              <ThemeIcon size="md" radius="xl" variant="light" color="teal" style={{ flexShrink: 0 }}>
