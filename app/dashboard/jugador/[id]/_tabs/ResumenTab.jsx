...
export default function ResumenTab({ jugador, evoluciones = [], messages = [], informes = [], activeSubtab, onSubtabChange, readOnly = false }) {
  return (
    <Stack gap={0}>
      <Paper
        p="xs"
      ...
      <Box mt={0}>
        {activeSubtab === 'perfil' && <PerfilSubtab jugador={jugador} evoluciones={evoluciones} informes={informes} readOnly={readOnly} />}
