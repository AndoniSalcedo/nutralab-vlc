...
function buildPrompt({ jugador, contextoAdicional, menu, baseData, retry = false, recomendacionesIngestas, preMatchConfig }) {
  ...
  return [
    ...
    '- Es obligatorio indicar la cantidad y unidad de CADA ingrediente medible que aparezca en el detalle. En especial, nunca omitas los gramos del aceite/AOVE: escribe, por ejemplo, "Aceite de oliva virgen extra (4 g)". No sustituyas cantidades pequeñas por "un chorrito" ni las elimines.',
...
function buildReviewPrompt({ jugador, contextoAdicional, menu, planData, recomendacionesIngestas, preMatchConfig }) {
  ...
  return [
    ...
    '- Conserva y muestra la cantidad de cada ingrediente medible del detalle. En particular, el aceite/AOVE debe figurar siempre con gramos explícitos, incluso si son cantidades pequeñas como 4 g.',
