...
export function buildWeeklyPrompt({ jugador, baseData, menu, preMatchConfig, contextoAdicional, recomendacionesIngestas }) {
  ...
  const payload = {
    ...
    reglas_calidad_nutricional_y_variedad: [
      ...
      '5. LIBERTAD GASTRONÓMICA Y CUADRE MATEMÁTICO: La tabla de composición nutricional es una guía de referencia de macros estándar por 100g para el cálculo exacto, pero TIENES LIBERTAD TOTAL para utilizar cualquier alimento saludable y compatible de la gastronomía mediterránea y deportiva (ej: dorada, sepia, calamar, pulpo, conejo, cuscús, fideos de arroz, gnocchi, queso cottage, edamame, frutos secos y frutas variadas). Evita dietas monótonas de culturista; diseña menús ricos, sabrosos y variados, calculando los gramos exactos para cumplir las macros de cada ingesta (tolerancia máxima ±5%). Si la carne/pescado no alcanza la proteína marcada, añade complementos proteicos limpios (claras de huevo, yogur proteico/sin lactosa, queso fresco batido, huevo cocido, lata de atún al natural).',
