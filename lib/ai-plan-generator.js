...
function buildReviewPrompt({ jugador, contextoAdicional, menu, planData, recomendacionesIngestas, preMatchConfig }) {
  ...
  return [
    ...
    '- Salvo para corregir faltas de gramos o resolver conflictos de salud/pre-partido, mantén el resto de la estructura y contenido de las ingestas tal como están.',
    '',
    'Jugador:',
    playerContextToPrompt(jugador),
    '',
