...
export function resolveMealTreeForDay(treeOrRaw, dayIndex = 0, mealName = 'Comida', clinicalCatalog = null, player = null, isPreMatch = false, tracker = null) {
  ...
  for (const branch of tree.branches) {
    ...
    } else if (isDinner && ['legumbres', 'lentejas', 'garbanzos', 'alubias'].some((term) => bId.includes(term))) {
      resolvedParts.push(resolveGenericCarbNode(clinicalCatalog, player, tracker, isPreMatch, true));
    } else if (bId === 'panes') {
