...
function mapTypedMeasurement(row, lookup) {
  ...
  if (typed.masa_magra_kg === null && typed.peso_kg !== null && typed.porcentaje_grasa !== null) {
    typed.masa_magra_kg = Math.round(typed.peso_kg * (1 - typed.porcentaje_grasa / 100) * 100) / 100;
  }
  if (typed.peso_magro === null && typed.masa_magra_kg !== null) {
    typed.peso_magro = typed.masa_magra_kg;
  }
