...
import { calibrateMeal, FOOD_NORMALIZED_NAMES_LIST, findFoodInCatalog } from '@/lib/nutrition/calculator';
import {
  AI_NUTRITION_RULES,
...
export function buildWeeklyPromptWithoutMenu({ jugador, baseData, preMatchConfig, contextoAdicional, recomendacionesIngestas }) {
  ...
  const payload = {
    ...
    catalogo_alimentos_oficiales_disponibles: FOOD_NORMALIZED_NAMES_LIST,
