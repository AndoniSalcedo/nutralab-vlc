...
import { PLAN_DAY_TYPES, getUserMeals } from './nutrition-day-types.js';
...
export function buildBasePlanData({ jugador, nombre, contexto, contextoAdicional, menu, calendario, teamConfig }) {
