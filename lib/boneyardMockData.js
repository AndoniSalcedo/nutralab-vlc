...
export const mockTeam = {
  ...
  configuracion_nutricional: {
    ...
    dayTypes: [
      { key: 'match_day', label: 'Día de Partido', color: 'red', tienePreentreno: true, tienePostentreno: true },
      { key: 'training_heavy', label: 'Entrenamiento Intenso', color: 'orange', tienePreentreno: true, tienePostentreno: true },
      { key: 'training_light', label: 'Entrenamiento Ligero', color: 'blue', tienePreentreno: false, tienePostentreno: true },
      { key: 'rest_day', label: 'Descanso', color: 'gray', tienePreentreno: false, tienePostentreno: false },
    ],
    protocols: [
      {
        id: 'proto_match_1',
        dayTypeKey: 'match_day',
        name: 'Protocolo Pre-Partido Valencia',
        incluirEnPlan: true,
        timeline: [
          { id: '1', timeLabel: '-3h', title: 'Comida pre-partido', description: 'Carbohidratos complejos + proteína magra', icon: 'IconMeat' },
          { id: '2', timeLabel: '-90m', title: 'Activación e hidratación', description: '500ml bebida isotónica con electrolitos', icon: 'IconDroplet' },
          { id: '3', timeLabel: '-30m', title: 'Top-up energético', description: 'Gel energético o cafeína según tolerancia', icon: 'IconCoffee' },
          { id: '4', timeLabel: 'Post', title: 'Recuperación inmediata', description: 'Batido recovery 3:1 carbohidratos/proteína', icon: 'IconBatteryCharging' },
        ],
        checklist: [
          { id: 'c1', title: 'Hidratación previa', description: 'Color de orina claro en las 3 horas previas' },
          { id: 'c2', title: 'Digestión', description: 'Evitar grasas y exceso de fibra 3h antes' },
          { id: 'c3', title: 'Suplementos asignados', description: 'Tomar cafeína/nitratos según pauta' },
        ]
      }
    ],
    planColors: {
...
export const mockMeals = [
  {
    ...
    meal_type: 'breakfast',
    ingredients: ['Huevos (120g)', 'Pan integral (50g)', 'Aceite de oliva (5g)'],
    calories: 380,
    notes: 'Desayuno post-entreno suave.',
    photo_size: null,
    photo_mime: null,
  },
  {
    ...
    meal_type: 'lunch',
    ingredients: ['Pechuga de pollo (150g)', 'Arroz basmati (100g)', 'Aguacate (50g)'],
    calories: 620,
    notes: 'Almuerzo principal.',
    photo_size: null,
    photo_mime: null,
  }
];
