export const AI_NUTRITION_RULES = [
  ...
  '3. MÁXIMA VARIEDAD SEMANAL Y PROHIBIDO REPETIR PROTEÍNA EN EL MISMO DÍA: En toda la semana, PROHIBIDO repetir la misma fuente de proteína en la comida y en la cena del mismo día (ej: NUNCA ternera/hamburguesa en comida y ternera/hamburguesa en cena). Si a mediodía se toma carne roja/vacuno, por la noche debe ser ave (pollo/pavo), pescado blanco/azul, marisco o huevos, y viceversa. ROTA continuamente entre todas las fuentes de proteína (ternera magra, pechuga/contramuslo de pollo, pavo, conejo, pescados blancos [merluza, dorada, lubina, lenguado, bacalao], mariscos [sepia, calamar, pulpo, gambas], pescados azules [salmón, Atún fresco, bonito, emperador], huevos y legumbres aptas). ROTA también los hidratos (arroz blanco/basmati/jazmín, arroz integral, pasta, fideos de arroz, cuscús, gnocchi, patata, boniato, avena, quinoa). PROHIBIDO servir el mismo plato o la misma combinación de proteína e hidrato en días consecutivos.',
  '4. OBLIGACIÓN ABSOLUTA DE PROTEÍNA LIMPIA EN TODA COMIDA Y CENA: En toda Comida y en toda Cena principal es TERMINANTE Y ABSOLUTAMENTE OBLIGATORIO incluir exactamente una fuente de proteína principal limpia y de alto valor biológico del catálogo oficial (carnes y aves: Pechuga de pollo, Pechuga de pavo, Ternera magra, Solomillo de ternera, Conejo; pescados blancos o azules: Merluza, Dorada, Lubina, Bacalao, Salmón, Atún fresco, Corvina, Rape; mariscos: Sepia, Calamar, Gambas; o huevos: Huevos enteros, Claras de huevo). Queda TERMINANTEMENTE PROHIBIDO diseñar una comida o cena basada únicamente en carbohidratos, verduras, pseudocereales (quinoa sola) o bebidas/líquidos (como agua de coco) sin una proteína limpia de plato. PROHIBIDO prescribir latas o conservas de atún (Atún natural, Atún natural conserva natural, Atún natural conserva aceite) como proteína de plato en Comida o Cena (las conservas quedan reservadas exclusivamente para meriendas o desayunos; en Comida y Cena el atún debe ser siempre "Atún fresco"). La proteína debe nombrarse explícitamente en el plato principal (ej: "Quinoa, Pechuga de pollo, Pepino, Tomate, AOVE, Fresas" o "Arroz blanco, Merluza, Calabacín, AOVE, Naranja").',
  '5. PREFERENCIAS DEL JUGADOR CON ELEVADA VARIABILIDAD: Si el jugador expresa preferencias, respeta esa base pero no repitas preparaciones idénticas todos los días. Rota dentro de esa familia de preferencias variando los alimentos y acompañamientos afines para no caer en la monotonía.',
  '6. SELECCIÓN DE ALIMENTOS DEL CATÁLOGO OFICIAL Y CÁLCULO PRECISO: Utiliza exclusivamente los nombres oficiales del catálogo disponible (ej: "Arroz blanco", "Solomillo de ternera", "Boniato", "Pechuga de pollo", "AOVE"). Tu rol primordial es gastronómico y clínico: decidir combinaciones ricas, variadas y seguras. NO calcules los gramos: la calculadora matemática de Nutralab ajustará y asignará automáticamente los gramos exactos de cada alimento según las macros requeridas por el jugador.',
  '7. SOLO INGREDIENTES LIMPIOS DEL CATÁLOGO (SIN GRAMOS NI MÉTODOS DE COCINADO): Nombra únicamente los alimentos individuales reales del catálogo oficial separados por comas (ej: "Arroz blanco, Pechuga de pollo, Brócoli, AOVE, Manzana"). NO calcules gramos: la calculadora matemática de Nutralab se encarga de fijar los gramajes exactos. PROHIBIDO nombrar mezclas híbridas en un solo ítem (no escribir "pollo y pavo" ni "manzana y pera"). PROHIBIDO añadir métodos de cocinado ("a la plancha", "al horno", "hervido") y PROHIBIDO escribir "(en crudo)".',
...
export const AI_MENU_NUTRITION_RULES = [
  ...
  '3. SELECCIÓN ESTRUCTURADA DEL BUFFET DEL COMEDOR Y OBLIGACIÓN DE PROTEÍNA: En cada comida y cena que dependa del menú de comedor, es TOTALMENTE OBLIGATORIO seleccionar del buffet disponible: 1) Exactamente UNA fuente de proteína principal limpia (pechuga de pollo, pavo, ternera magra, pescado blanco/azul [Merluza, Dorada, Lubina, Salmón, Atún fresco...] o huevos). PROHIBIDO usar conservas de atún en comida o cena. 2) Exactamente UNA base de hidratos de carbono (cereal o tubérculo). 3) Verduras y grasa saludable (AOVE). 4) Fruta fresca de postre. Queda TERMINANTEMENTE PROHIBIDO dejar una comida o cena sin fuente de proteína principal limpia o sustituirla por bebidas como agua de coco. Toda la proteína debe provenir íntegramente del plato principal (carne, ave, pescado o huevos limpios). QUEDA TERMINANTEMENTE PROHIBIDO añadir yogures o lácteos como postre en comida o cena (los yogures proteicos y quesos quedan reservados para meriendas, desayunos o medias mañanas). PROHIBIDO DUPLICAR O COMBINAR DOS BASES DE HIDRATOS COMPITIENDO: queda terminantemente prohibido elegir a la vez dos fuentes principales de hidrato en el mismo plato. Las barras ("/") en el menú representan alternativas entre las que debes elegir solo una.',
...
export function buildWeeklyPromptEnvelope(payloadJson) {
  return [
    ...
    'REGLA INQUEBRANTABLE DE PROTEÍNA: En toda Comida y en toda Cena principal DEBES incluir obligatoriamente exactamente una fuente de proteína limpia (pechuga de pollo, pavo, ternera magra, pescado blanco/azul o huevos). Jamás dejes una comida o cena sin proteína.',
    '',
...
export function buildWeeklyMenuPromptEnvelope(payloadJson) {
  return [
    ...
    '2. Selecciona UNA sola proteína y UNA sola base de hidratos (prohibido combinar dos bases pesadas de hidratos en el mismo plato). En cada Comida y Cena principal DEBES incluir obligatoriamente una fuente de proteína limpia (pollo, pavo, ternera, pescado o huevo), jamás omitas la proteína.',
